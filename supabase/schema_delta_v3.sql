-- ============================================================
-- DESTRAVA CRÉDITO — Schema Delta v3.0 (Integrações)
-- Execute este arquivo no SQL Editor do Supabase.
-- Ele adiciona APENAS o que falta no seu banco atual,
-- sem conflitar com as tabelas que você já tem.
-- ============================================================
...
-- O seu banco tem "valor_desejado" como TEXT. O servidor v3.0 espera "valor_solicitado" NUMERIC.
-- Vamos adicionar a coluna nova para o servidor usar, sem apagar a antiga.
ALTER TABLE public.leads
  ADD COLUMN IF NOT EXISTS valor_solicitado NUMERIC(15,2);

-- O seu banco tem "cpf_cnpj" (texto), o que está correto.
-- O seu banco já tem "created_at" e "updated_at".
...
-- Trigger de updated_at para leads
DO $$
BEGIN
...
-- ============================================================
-- BLOCO 5: n8n AUTOMAÇÕES (Tabelas Novas)
-- ============================================================
