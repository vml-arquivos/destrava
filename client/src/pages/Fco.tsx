...
const faqs = [
  {
    q: "O que é o FCO?",
    a: "O FCO é um fundo criado pela Constituição Federal para promover o desenvolvimento econômico e social da região Centro-Oeste, financiando projetos empresariais e rurais.",
  },
  {
    q: "Quem pode solicitar o FCO?",
    a: "Empresas, produtores rurais e empreendedores localizados nos estados de Goiás, Mato Grosso, Mato Grosso do Sul e no Distrito Federal.",
  },
  {
    q: "Qual é a taxa de juros do FCO?",
    a: "As taxas variam conforme a finalidade, o porte, o setor, a localização e a programação anual vigente. A condição aplicável deve ser confirmada antes da proposta.",
  },
  {
    q: "Qual o prazo máximo de financiamento?",
    a: "Os prazos e a carência dependem da linha e do projeto enquadrado na Programação FCO 2026 e da análise do agente financeiro.",
  },
  {
    q: "Quais bancos operam o FCO?",
    a: "O FCO é operado principalmente pelo Banco do Brasil, que possui agências em toda a região Centro-Oeste.",
  },
  {
    q: "Como a Destrava me ajuda com o FCO?",
    a: "Nossa equipe analisa a viabilidade do projeto, organiza a documentação, elabora o projeto de investimento e acompanha todo o processo junto ao banco operador.",
  },
];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <SEO
        ...
        description="FCO para empresas e produtores de GO, MT, MS e DF. Avalie enquadramento, projeto, documentos e condições da Programação FCO 2026."
        keywords="fco, fundo constitucional do centro-oeste"
        structuredData={serviceStructuredData(
          "FCO",
          "Orientação sobre enquadramento e preparação de projetos para linhas do Fundo Constitucional de Financiamento do Centro-Oeste."
        )}
      />
      <Header />
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/80 leading-relaxed mb-8">
              Financiamento para empresas, produtores rurais e empreendedores de
              GO, MT, MS e DF, conforme a finalidade e as condições da
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Button asChild
                ...
                >
                <a
                href="https://wa.me/556135268355?text=Ol%C3%A1!%20Quero%20saber%20mais%20sobre%20o%20FCO."
                target="_blank"
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-card p-6 rounded-lg border border-border text-center">
              ...
              <h3 className="font-bold text-lg mb-2">Enquadramento</h3>
              <p className="text-2xl font-bold text-primary mb-2">
                Programação 2026
              </p>
              <p className="text-sm text-muted-foreground">
                Conforme porte, setor e finalidade
              </p>
            </div>
            <div className="bg-card p-6 rounded-lg border border-border text-center">
              ...
              <p className="text-2xl font-bold text-primary mb-2">
                Condição por projeto
              </p>
              <p className="text-sm text-muted-foreground">
                Confirmada pelo agente financeiro
              </p>
            </div>
            <div className="bg-card p-6 rounded-lg border border-border text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Inclui carência quando prevista
              </p>
            </div>
            <div className="bg-card p-6 rounded-lg border border-border text-center">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div className="bg-card p-5 rounded-lg border border-border flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Construção, ampliação e modernização de instalações
                    produtivas.
                  </p>
                </div>
              </div>
              <div className="bg-card p-5 rounded-lg border border-border flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Capital de giro vinculado ao projeto de investimento
                    financiado.
                  </p>
                </div>
              </div>
              <div className="bg-card p-5 rounded-lg border border-border flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Financiamento de projetos rurais, pecuária, agricultura e
                    agroindústria.
                  </p>
                </div>
              </div>
              <div className="bg-card p-5 rounded-lg border border-border flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Projetos de turismo, hotelaria e serviços na região
                    Centro-Oeste.
                  </p>
                </div>
              </div>
              <div className="bg-card p-5 rounded-lg border border-border flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Projetos industriais de implantação, expansão e
                    modernização.
                  </p>
                </div>
              </div>
              <div className="bg-card p-5 rounded-lg border border-border flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Financiamento para empresas comerciais da região
                    Centro-Oeste.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-card p-6 rounded-lg border border-border">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2 text-sm">
                    ...
                    <span>
                      Empresa ou produtor rural localizado em GO, MT, MS ou DF
                    </span>
                  </li>
                  <li className="flex items-start gap-2 text-sm">
                    <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-2 text-sm">
                    <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0 mt-0.5" />
                    <span>
                      Projeto de investimento aprovado pelo banco operador
                    </span>
                  </li>
                  <li className="flex items-start gap-2 text-sm">
                    <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0 mt-0.5" />
      ...
      <section className="py-16 bg-gradient-to-br from-primary to-[var(--color-caixa-blue-dark)] text-white">
        <div className="container text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Acesse o FCO com a Destrava
          </h2>
          <p className="text-lg text-white/80 mb-8 max-w-xl mx-auto">
            Prepare o projeto e confirme as condições vigentes do FCO para sua
            empresa no Centro-Oeste.
          </p>
