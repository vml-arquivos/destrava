        ...
        <div className="container px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild
                  size="lg"
                  className="bg-orange-400 hover:bg-orange-500 text-black font-bold px-8"
                >
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-2xl border-2 border-red-100 p-8 shadow-sm">
                ...
                <Button asChild className="w-full mt-6 bg-red-500 hover:bg-red-600 text-white font-bold">
                  <Link href="/captura?produto=consulta-spc-serasa">
                    Consultar CPF
              ...
              <div className="bg-white rounded-2xl border-2 border-orange-100 p-8 shadow-sm">
                ...
                <Button asChild className="w-full mt-6 bg-orange-500 hover:bg-orange-600 text-white font-bold">
                  <Link href="/captura?produto=consulta-spc-serasa">
                    Consultar CNPJ
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={item}
                      className="flex items-center gap-3 p-3 bg-red-50 rounded-lg text-sm text-red-800"
                    >
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={item}
                      className="flex items-center gap-3 p-3 bg-green-50 rounded-lg text-sm text-green-800"
                    >
                      <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0" />
                      {item}
                    </div>
