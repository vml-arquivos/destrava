...
const faqs = [
  ...
  },
  {
    ...
    a: "Pelas regras divulgadas em julho de 2026, o volume pode chegar a 50% do faturamento e a 60% para empresas lideradas por mulheres, sujeito ao enquadramento e à instituição financeira.",
  },
  {
    ...
    <div className="min-h-screen flex flex-col bg-white">
      <SEO
        ...
        structuredData={serviceStructuredData(
          "ProCred 360",
          "Orientação para MEI e microempresas avaliarem elegibilidade e documentação do ProCred 360 conforme as regras vigentes."
        )}
      />
      <Header />
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-card p-6 rounded-lg border border-border text-center">
              ...
              <p className="text-sm text-muted-foreground">
                *Até 50% menores que o mercado convencional
              </p>
            </div>
            <div className="bg-card p-6 rounded-lg border border-border text-center">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div className="bg-card p-5 rounded-lg border border-border flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Abrir novo ponto, ampliar o espaço físico ou diversificar
                    produtos e serviços.
                  </p>
                </div>
              </div>
              <div className="bg-card p-5 rounded-lg border border-border flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Investir em presença online, redes sociais e ferramentas de
                    gestão.
                  </p>
                </div>
              </div>
