  ...
  return (
    <div className="min-h-screen bg-card pb-20 text-foreground md:pb-0">
      ...
      <main>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-[1.08fr_.92fr] lg:gap-16">
              <div className="max-w-3xl">
                ...
                <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
                  ...
                  <Button asChild size="lg" variant="outline" className="h-13 rounded-xl border-white/30 bg-transparent px-7 text-base font-bold text-primary-foreground hover:bg-card/10 hover:text-primary-foreground">
              ...
              <div className="mx-auto w-full max-w-lg lg:mx-0 lg:justify-self-end">
                <div className="relative rounded-[2rem] border border-white/10 bg-[#0c1d3b] p-6 shadow-2xl shadow-black/30 sm:p-8">
                  ...
                  <div className="my-7 h-px bg-card/10" />
        ...
        <section className="border-b border-border bg-card py-10" aria-labelledby="a1-seguranca-title">
          <div className="container px-4">
            <div className="mx-auto flex max-w-5xl flex-col items-center gap-8 sm:flex-row sm:items-center">
              ...
              <div className="text-center sm:text-left">
                <h2 id="a1-seguranca-title" className="text-xl font-black text-foreground sm:text-2xl">
                ...
                <ul className="mt-4 flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs font-bold uppercase tracking-wide text-muted-foreground sm:justify-start">
                  <li className="flex items-center gap-1.5"><ShieldCheck className="h-4 w-4 text-success" aria-hidden="true" /> ICP-Brasil</li>
                  <li className="flex items-center gap-1.5"><ShieldCheck className="h-4 w-4 text-success" aria-hidden="true" /> Conforme LGPD</li>
                  <li className="flex items-center gap-1.5"><ShieldCheck className="h-4 w-4 text-success" aria-hidden="true" /> Suporte humano</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="border-b border-destructive/20 bg-destructive/10 py-12 sm:py-14" aria-labelledby="a1-pain-title">
          <div className="container px-4">
            <div className="mx-auto max-w-6xl rounded-3xl border border-destructive/20 bg-card p-6 shadow-sm sm:p-8 lg:p-10">
              <div className="grid gap-8 lg:grid-cols-[.75fr_1.25fr] lg:items-center">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {painPoints.map((item) => (
                    <div key={item} className="flex items-start gap-3 rounded-2xl border border-destructive/20 bg-destructive/10/70 p-4">
        ...
        <section className="bg-muted py-16 sm:py-20" aria-labelledby="a1-solution-title">
          <div className="container px-4">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/20 text-primary">
            ...
            <div className="mx-auto mt-10 grid max-w-6xl gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {a1Benefits.map((benefit) => (
                <article key={benefit.title} className="rounded-3xl border border-border bg-card p-6 shadow-sm transition-transform duration-200 hover:-translate-y-1">
            ...
            <div className="mt-9 text-center">
              <Button asChild size="lg" className="h-12 rounded-xl bg-primary px-7 font-black text-primary-foreground hover:bg-primary/90">
                <Link href={CAPTURE_URL}>
                  Quero meu A1 em 1H
                  <ArrowRight className="h-5 w-5" aria-hidden="true" />
                </Link>
        ...
        <section className="bg-card py-16 sm:py-20" aria-labelledby="a1-comparison-title">
          <div className="container px-4">
            <div className="mx-auto max-w-3xl text-center">
              <p className="text-sm font-black uppercase tracking-[0.2em] text-primary">Escolha com clareza</p>
              ...
              <p className="mt-4 leading-7 text-muted-foreground">Para emissão rápida e uso recorrente no computador, o A1 costuma ser a alternativa mais prática.</p>
            </div>

            <div className="mx-auto mt-10 max-w-5xl overflow-hidden rounded-3xl border border-border shadow-lg shadow-slate-200/50">
            ...
            <div className="mt-8 text-center">
              <Button asChild variant="outline" size="lg" className="h-12 rounded-xl border-primary/20 px-7 font-bold text-primary hover:bg-primary/10 hover:text-primary">
                <Link href={CAPTURE_URL}>
        ...
        <section className="bg-muted py-16 sm:py-20" aria-labelledby="a1-authority-title">
          <div className="container px-4">
            <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_.9fr] lg:items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full bg-primary/20 px-4 py-2 text-sm font-black text-primary">
              ...
              <aside className="rounded-[2rem] bg-card p-7 shadow-xl shadow-slate-200/70 ring-1 ring-slate-200 sm:p-9" aria-label="Compromissos de atendimento">
                ...
                <ul className="mt-7 space-y-4">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-sm font-semibold leading-6 text-foreground">
                      <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-success" aria-hidden="true" />
                      {item}
                    </li>
                  ))}
                </ul>
                <Button asChild variant="outline" size="lg" className="mt-8 h-12 w-full rounded-xl border-primary/20 text-primary hover:bg-primary/10 hover:text-primary">
        ...
        <section className="bg-card py-16 sm:py-20" aria-labelledby="a1-faq-title">
          <div className="container px-4">
          ...
          <div className="container relative px-4">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                ...
                <Button asChild size="lg" variant="outline" className="h-13 rounded-xl border-white/30 bg-transparent px-8 text-base font-bold text-primary-foreground hover:bg-card/10 hover:text-primary-foreground">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-40 hidden h-14 w-14 items-center justify-center rounded-full bg-success text-primary-foreground shadow-xl shadow-emerald-900/30 transition hover:scale-105 hover:bg-success md:flex"
      >
        <MessageCircle className="h-7 w-7" aria-hidden="true" />
        <span className="absolute right-full mr-3 whitespace-nowrap rounded-lg bg-brand-navy px-3 py-1.5 text-xs font-semibold text-primary-foreground opacity-0 shadow-lg transition group-hover:opacity-100 pointer-events-none">
          Falar no WhatsApp
        </span>
      </a>
    </div>
