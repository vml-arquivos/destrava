  ...
  async function handleSalvar() {
    ...
    try {
      ...
      await supabase.from("simulacoes_colaborador").insert({
        ...
        total_emprestimo: resultado.totalFinanciamento,
    ...
    try {
      ...
      if (resA) {
        await supabase.from("simulacoes_colaborador").insert({
          ...
          valor_fiscal: parseBRL(form.valorFiscal) || null,
          pct_imposto: parseFloat(form.pctImposto) || null,
          imposto_valor: resA.impostoValor || null,
          comissao_valor: resA.comissaoValor,
          parcela_mensal: resA.parcelaMensal,
          total_emprestimo: resA.totalFinanciamento,
          total_juros: resA.totalJuros,
          custo_total: resA.custoTotalOperacao,
          cenario: "com_imposto",
        });
      }
      if (resB) {
        await supabase.from("simulacoes_colaborador").insert({
          ...
          comissao_valor: resB.comissaoValor,
          parcela_mensal: resB.parcelaMensal,
          total_emprestimo: resB.totalFinanciamento,
          total_juros: resB.totalJuros,
          custo_total: resB.custoTotalOperacao,
          cenario: "sem_imposto",
        });
      }
      setSalvo(true);
