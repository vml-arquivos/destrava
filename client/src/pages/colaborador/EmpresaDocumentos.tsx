...
// CORREÇÃO (10/09/2026, causa raiz real do "CCMEI nunca aparece na tela"): "ccmei",
// "das_mei" e "relatorio_receitas_mei" têm slot cadastrado no catálogo mas nunca
// estiveram nesta lista -- por isso o card de anexar o CCMEI nunca podia ser
// renderizado, independente de qualquer regra de MEI. Ver o mesmo comentário,
// mais detalhado, em AcervoDocumentalEmpresa.tsx (TIPOS_EMPRESA).
const TIPOS_PERMITIDOS_EMPRESA = ["contrato_prestacao_servicos", "cartao_cnpj", "qsa", "atos_junta_comercial", "contrato_social", "alteracao_contratual", "documento_socio", "rg", "cnh", "cpf", "passaporte", "comprovante_residencia", "irpf", "recibo_irpf", "certidao_casamento", "averbacao_divorcio", "certidao_obito", "rating_bacen_cnpj", "rating_bacen_cpf", "cenprot_cnpj", "cenprot_cpf", "cnd_rfb_cnpj", "cnd_rfb_cpf", "cadin_cnpj", "cadin_cpf", "pgfn_cnpj", "pgfn_cpf", "situacao_fiscal_cnpj", "situacao_fiscal_cpf", "enquadramento_tributario_cnpj", "simples_nacional", "pgdas", "pgmei", "ccmei", "das_mei", "relatorio_receitas_mei", "ecf", "recibo_ecf", "recibo_pgdas", "recibo_pgmei", "defis", "dasn_simei", "recibo_defis", "recibo_dasn_simei", "scr_cnpj", "ccs_cnpj", "ccf_cnpj", "scr_cpf", "ccs_cpf", "ccf_cpf", "consulta_serasa_cpf", "compartilhamento_ecac", "foto_fachada", "foto_interna_1", "foto_interna_2", "foto_interna_3", "faturamento_12_meses", "outros"];
