...
export default function Produtos() {
  return (
    <div className="min-h-screen flex flex-col bg-card">
      ...
      {/* HERO SECTION */}
      <section className="bg-gradient-to-br from-[var(--color-caixa-blue)] via-[var(--color-caixa-blue-dark)] to-[#001a4d] text-primary-foreground py-12 md:py-20 relative overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-6">
          ...
          <p className="text-base md:text-lg lg:text-2xl text-primary-foreground/90 mb-6 md:mb-8 leading-relaxed max-w-2xl">
      ...
      <section className="py-8 md:py-20 bg-muted">
        <div className="container px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-6 md:gap-12">
            ...
            <div className="bg-gradient-to-br from-[var(--color-caixa-blue)] to-[var(--color-caixa-blue-dark)] text-primary-foreground p-6 md:p-12 rounded-xl md:rounded-2xl shadow-lg md:shadow-2xl">
              <div className="flex items-start justify-between mb-4 md:mb-6">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold mb-1 md:mb-2">Assessoria de Crédito</h2>
                  <p className="text-base md:text-lg text-primary-foreground/90">Captação de Recursos Customizada</p>
                </div>
              </div>
              ...
              <p className="text-primary-foreground/80 mb-4 md:mb-6 italic border-l-4 border-[var(--color-caixa-yellow)] pl-3 md:pl-4 text-sm md:text-base">
              ...
              <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                <div className="flex items-start gap-2 md:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/70 text-xs md:text-sm">Avaliamos sua situação financeira para identificar a melhor solução</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 md:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/70 text-xs md:text-sm">Buscamos as melhores linhas de crédito disponíveis no mercado</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 md:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/70 text-xs md:text-sm">Ajudamos na preparação de documentação e negociação</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 md:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/70 text-xs md:text-sm">Limpeza de nome e restauração de histórico creditício</p>
                  </div>
                </div>
              </div>

              <Button asChild className="w-full bg-[var(--color-caixa-yellow)] hover:bg-warning text-foreground font-bold text-sm md:text-base py-2 md:py-3 px-4 md:px-8">
            ...
            <div className="bg-card border-2 border-border p-6 md:p-12 rounded-xl md:rounded-2xl">
              <h2 className="text-2xl md:text-3xl font-bold mb-1 md:mb-2 text-[var(--color-caixa-blue-dark)]">Produtos de Crédito</h2>
              <p className="text-base md:text-lg text-muted-foreground mb-4 md:mb-6">Linhas de Crédito Disponíveis</p>
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-start gap-2 md:gap-3 pb-3 md:pb-4 border-b border-border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs md:text-sm">Capital de giro sujeito às condições e à análise da CAIXA</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 md:gap-3 pb-3 md:pb-4 border-b border-border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs md:text-sm">Programa de apoio a micro e pequenas empresas</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 md:gap-3 pb-3 md:pb-4 border-b border-border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs md:text-sm">Para aquisição de imóvel comercial ou residencial</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 md:gap-3 pb-3 md:pb-4 border-b border-border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs md:text-sm">Para diferentes finalidades, sujeito à análise da instituição</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 md:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs md:text-sm">Com desconto em folha. Ideal para servidores públicos</p>
                  </div>
                </div>
              </div>

              <Button asChild variant="outline" className="w-full mt-6 md:mt-8 border-[var(--color-caixa-blue)] text-[var(--color-caixa-blue)] hover:bg-primary/10 font-bold text-sm md:text-base py-2 md:py-3 px-4 md:px-8">
                <a href="https://wa.me/556135268355" target="_blank" rel="noopener noreferrer">
      ...
      <section className="py-8 md:py-16 bg-gradient-to-r from-blue-50 to-blue-100">
        <div className="container max-w-3xl px-4 md:px-6">
          <div className="bg-card rounded-lg md:rounded-xl p-6 md:p-12 shadow-lg text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[var(--color-caixa-blue-dark)] mb-3 md:mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
              <Button asChild size="lg" className="bg-[var(--color-caixa-blue)] hover:bg-primary text-primary-foreground font-bold text-sm md:text-base py-2 md:py-3 px-4 md:px-8">
                <a href="https://wa.me/556135268355" target="_blank" rel="noopener noreferrer">
                  Conversar com Especialista
                </a>
              </Button>
      ...
      {/* DISCLAIMER */}
      <section className="bg-muted py-6 md:py-8 text-center text-xs md:text-sm text-muted-foreground">
        <div className="container px-4 md:px-6">
