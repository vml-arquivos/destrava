        ...
        <div className="container px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="https://wa.me/556135268355?text=Olá! Quero consultar o rating da minha empresa no Banco Central." target="_blank" rel="noopener noreferrer">
        ...
        <div className="container px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="https://wa.me/556135268355?text=Olá! Quero saber mais sobre rating empresarial no Banco Central." target="_blank" rel="noopener noreferrer">
                <Button size="lg" variant="outline" className="border-white/40 text-white hover:bg-white/10 font-bold px-8">
                  Falar no WhatsApp
                </Button>
              </a>
