        ...
        <div className="fixed inset-0 z-50 bg-overlay p-4 flex items-center justify-center">
          ...
          {modulosRelatorio.length > 0 && <div className="rounded-xl border border-primary/25 bg-card p-3">
            <div className="flex flex-col gap-1 md:flex-row md:items-start md:justify-between">
              <div><p className="text-xs font-black text-primary">Relatório por módulos</p><p className="mt-1 text-[10px] text-muted-foreground">Índice institucional com identificação, documentos, sócios, consultas e resumo. O conteúdo interno da assessoria não aparece neste modo.</p></div>
