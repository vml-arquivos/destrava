...
export default function AcervoDocumentalWorkspace({
  ...
  if (mode === "upload") {
    return (
      <div className="flex max-h-[calc(100vh-168px)] min-h-[560px] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        <div className="shrink-0 border-b border-slate-200 px-5 py-3 flex flex-col lg:flex-row lg:items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-0.5 text-sm text-slate-500">Selecione a categoria, anexe um único arquivo e salve no acervo.</p>
          </div>
        ...
        <div className="grid flex-1 min-h-0 grid-cols-1 xl:grid-cols-[320px_minmax(0,1fr)] overflow-y-auto">
          <aside className="border-b xl:border-b-0 xl:border-r border-slate-200 bg-slate-50/70 p-4 xl:sticky xl:top-0 xl:self-start">
          ...
          <section className="p-4 lg:p-6">
            <div className="mx-auto max-w-5xl">
              <div
                ...
                className={`min-h-[210px] rounded-3xl border-2 border-dashed flex flex-col items-center justify-center text-center p-6 transition ${dragging ? "border-blue-500 bg-blue-50" : uploadDraft.file ? "border-emerald-300 bg-emerald-50/50" : "border-slate-300 bg-slate-50 hover:border-blue-300"}`}
              >
                {uploadDraft.file ? (
                  <>
                    ...
                    <div className="mt-5 flex flex-wrap items-center justify-center gap-2">
                      {uploadPreviewUrl && (
                        <a href={uploadPreviewUrl} target="_blank" rel="noreferrer" className="h-10 px-4 rounded-xl border border-blue-200 bg-blue-50 text-sm font-bold text-blue-700 inline-flex items-center gap-2">
              ...
              <div className="sticky bottom-0 -mx-4 mt-6 border-t border-slate-200 bg-white/95 px-4 py-3 shadow-[0_-14px_34px_rgba(15,23,42,0.08)] backdrop-blur lg:-mx-6 lg:px-6">
