...
export default function Footer() {
  ...
  const linksServicos = [
    ...
    { label: "Calculadora de Score", href: "/calculadora-score" },
  ...
  return (
    <footer className="bg-[var(--color-caixa-blue-dark)] text-primary-foreground">
      <div className="container py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div className="lg:col-span-2">
            ...
            />
            <p className="text-sm text-primary-foreground/80 mb-5 leading-relaxed max-w-xs">
            ...
            <p className="text-xs text-primary-foreground/50 mb-5 leading-relaxed max-w-xs italic">
            ...
            <div className="flex gap-4 mb-5">
              <a href={COMPANY.instagramUrl} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-card/10 hover:bg-[var(--color-caixa-yellow)] hover:text-foreground flex items-center justify-center transition-all"
            ...
            <div className="space-y-2 text-sm text-primary-foreground/70">
              <div className="flex items-center gap-2">
                ...
                <a href={COMPANY.telefoneLink} className="hover:text-primary-foreground transition-colors">{COMPANY.telefone}</a>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-[var(--color-caixa-yellow)]" />
                <a href={COMPANY.emailLink} className="hover:text-primary-foreground transition-colors">{COMPANY.email}</a>
              </div>
            </div>
            ...
            <div className="mt-5 space-y-3">
              ...
              <div className="flex items-start gap-2 text-sm text-primary-foreground/70">
                ...
                <div>
                  <p className="font-semibold text-primary-foreground/90">Sede — Brasília / DF</p>
                  <a
              ...
              <div className="flex items-start gap-2 text-sm text-primary-foreground/70">
                <MapPin className="h-4 w-4 text-[var(--color-caixa-yellow)] flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-semibold text-primary-foreground/90">Filial — Goiânia / GO</p>
                  <a
          ...
          <div>
            ...
            <ul className="space-y-2">
              {linksCredito.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-sm text-primary-foreground/70 hover:text-[var(--color-caixa-yellow)] transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-white/20 pt-8">
          {/* Disclaimer Legal */}
          <div className="bg-card/10 rounded-xl p-5 mb-6">
