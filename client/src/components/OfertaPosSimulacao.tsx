  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] p-0 overflow-hidden">
        ...
        {step === "ebook" && (
          <>
            <div className="bg-[#0033A0] p-6 text-primary-foreground text-center relative overflow-hidden">
        ...
        {step === "checkout_ebook" && (
          <>
            ...
            <div className="p-6">
              <div className="bg-card border rounded-xl p-4 mb-6 shadow-sm">
                <div className="flex justify-between items-center mb-4 pb-4 border-b">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-foreground">E-book: Checklist Definitivo</p>
                      <p className="text-xs text-muted-foreground">Entrega imediata em PDF</p>
                    </div>
                  </div>
              ...
              <div className="bg-primary/10 text-primary text-sm p-4 rounded-xl border border-primary/20 mb-6 flex items-start gap-3">
              ...
              <Button 
                ...
                className="w-full bg-[#0033A0] hover:bg-[#002280] text-primary-foreground py-6 rounded-xl text-lg font-bold"
              >
          ...
          <>
            ...
            <div className="p-6">
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-2 w-full bg-muted hover:bg-border text-foreground font-semibold py-4 rounded-xl mb-8 transition-colors border border-input"
              >
        ...
        {step === "assessoria" && (
          <>
            ...
            <div className="p-6">
              <p className="text-foreground mb-5 text-center">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-primary/10 p-3 rounded-xl text-center border border-primary/20">
                  ...
                  <p className="text-xs text-muted-foreground">Foco no seu negócio</p>
                </div>
                <div className="bg-primary/10 p-3 rounded-xl text-center border border-primary/20">
                  <p className="text-xl font-bold text-[#0033A0]">+30</p>
                  <p className="text-xs text-muted-foreground">Bancos parceiros</p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              {downloadLiberado && (
                <a 
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center gap-2 w-full bg-primary/10 hover:bg-primary/20 text-[#0033A0] font-semibold py-3 rounded-xl transition-colors border border-primary/20"
                >
