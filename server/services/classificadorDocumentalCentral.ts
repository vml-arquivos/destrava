...
function tipoEsperadoCanonico(tipoEsperado: string): string {
  ...
  const familias: Record<string, string> = {
    ...
    contrato_social: 'CONTRATO_SOCIAL', alteracao_contratual: 'ALTERACAO_CONTRATUAL', requerimento_empresario: 'REQUERIMENTO_EMPRESARIO', estatuto: 'ESTATUTO', ata: 'ATA',
    ...
    comprovante_residencia: 'COMPROVANTE_RESIDENCIA', imposto_renda: 'IRPF', cnd_rfb_cnpj: 'CND', cnd_rfb_cpf: 'CND',
    ...
    contas_pagar: 'CONTAS_PAGAR', estoque: 'ESTOQUE', capital_giro: 'CAPITAL_GIRO', garantia: 'GARANTIA', contrato_garantia: 'GARANTIA',
    alienacao_fiduciaria: 'ALIENACAO_FIDUCIARIA', aval: 'AVAL', nota_promissoria: 'NOTA_PROMISSORIA', patrimonio_garantia: 'GARANTIA',
